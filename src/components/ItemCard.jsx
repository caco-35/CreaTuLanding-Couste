import { Card, CardContent, IconButton, CardMedia, Typography, TextField, CardActions, Divider } from "@mui/material";
...
const ItemCard = ({nombre, precio, descripcion, stock}) => {
  ...
  return (
    <Card className="card">
        <CardMedia sx={{ height: 150, width: 180, backgroundSize: "cover", backgroundPosition: "center", margin:"auto" }} image={fondo} title='fondo card' />
